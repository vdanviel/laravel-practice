    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a @if(Route::current()->uri() == 'carrinhos') class="nav-link active" @else class="nav-link" @endif href="/carrinho">Carrinho</a>
...
<body class="h-100 d-flex flex-column" style="min-height: 100vh;">

  <main style="flex:1;">
    @yield('content')
  </main>

    <footer style="margin-top: auto" class="bg-body-tertiary d-flex justify-content-end">
